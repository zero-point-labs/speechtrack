  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-orange-50 p-3 sm:p-4 lg:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Tutorial Card */}
        <TutorialCard
          title="Οδηγός Διαχείρισης Φακέλων Συνεδριών"
          description="Μάθετε πώς να δημιουργείτε, διαχειρίζεστε και παρακολουθείτε φακέλους συνεδριών για κάθε μαθητή."
          steps={[
            {
              title: "Δημιουργία Νέου Φακέλου",
              description: "Κάντε κλικ στο κουμπί 'Νέος Φάκελος' για να δημιουργήσετε θεραπευτικό πρόγραμμα.",
              action: "Συμπληρώστε το όνομα, περιγραφή και επιλέξτε εβδομάδες/συνεδρίες"
            },
            {
              title: "Ρύθμιση Προγράμματος",
              description: "Επιλέξτε συνολικές εβδομάδες, συνεδρίες ανά εβδομάδα και προκαθορισμένα πρότυπα συνεδριών.",
              action: "Χρησιμοποιήστε τα dropdown menus για γρήγορη διαμόρφωση"
            },
            {
              title: "Προβολή και Επεξεργασία",
              description: "Κάντε κλικ στο εικονίδιο ματιού για να δείτε τις συνεδρίες κάθε φακέλου.",
              action: "Από εκεί μπορείτε να επεξεργαστείτε μεμονωμένες συνεδρίες"
            },
            {
              title: "Διαγραφή και Διαχείριση",
              description: "Χρησιμοποιήστε το εικονίδιο κάδου για να διαγράψετε φακέλους που δεν χρειάζεστε πια.",
              action: "Προσοχή: Η διαγραφή φακέλου διαγράφει και όλες τις συνεδρίες του"
            }
          ]}
        />
      </div>
